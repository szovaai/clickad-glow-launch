...
serve(async (req) => {
  ...
  try {
    ...
    const { sessionId } = RequestSchema.parse(raw);
            ...
            <div class="container">
              ...
              <div class="content">
                ...
                <div class="highlight">
                  ...
                  Package: ${safePackageName}<br>
                  Amount: ${packageInfo.price} CAD
                </div>

                <h3>What Happens Next:</h3>
                <div class="step"><span class="step-number">1</span><div><strong>Welcome Call (Within 24 Hours)</strong><br>I'll reach out to schedule your 30-minute kickoff call.</div></div>
                <div class="step"><span class="step-number">2</span><div><strong>Strategy & Design (Days 2-5)</strong><br>We'll create your sitemap, wireframes, and initial design concepts.</div></div>
                <div class="step"><span class="step-number">3</span><div><strong>Development & Launch (Days 6-14)</strong><br>Your website is built, tested, and launched with full training.</div></div>
    ...
    try {
      await resend.emails.send({
        ...
        subject: `💰 New Payment - ${safePackageName}`,
        html: `
          <div style="font-family: -apple-system, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: #f8fafc; padding: 30px; border-radius: 0 0 10px 10px;">
              ...
              <div style="background: white; padding: 15px; border-radius: 8px; margin: 10px 0;">
                <strong>Customer Email:</strong> ${safeCustomerEmail}<br>
                <strong>Customer Name:</strong> ${safeCustomerName}<br>
                <strong>Package:</strong> ${safePackageName}<br>
                <strong>Amount:</strong> ${packageInfo.price} CAD
              </div>
